				...
				<!-- 회원 배송 정보 -->
					<div class="col-sm-8" id="deliveryDetail">
						<table>
							...
							<tr>
								<td>* 휴대폰 번호</td>
								<td><input type="text" class="form-control" id="deliveryPhone" value="${member1.phone}" maxlength = "13" 
								oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onKeyup="inputPhoneNumber();"/></td>
							</tr>							
							<tr>
								<td>* 배송지</td>
								<td>
