					...
					<div class="col-sm-offset-1 col-sm-9">
						<form class = "form-horizontal" id = "frm" method="post" action="${contextPath}/member/memberUpdate">
							...
							<div class = "form-group">
								...
								<div class = "col-sm-4">
									<input type = "text" class = "form-control" id = "phone" name = "phone" maxlength = "13" value = "${member1.phone }"
									oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" onKeyup="inputPhoneNumber();"/>
								</div>
							</div>
